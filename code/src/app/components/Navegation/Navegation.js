          ...
          <nav className={`${Styles.menu} ${
            ...
            <div className={Styles.links}>
              <Link className={Styles.link} href="/">
                <img src="home.png" alt="home" width="30px" height="30px" /> <p className={
            isMenuOpen ? Styles.p__open : Styles.p__closed
          }>Home</p>
              </Link>
              <Link className={`${Styles.link} ${Styles.separator}`} href="/quickRecipes">
                <img src="stopwatch.png" alt="quick recipes" width="30px" height="30px" /> <p className={
            isMenuOpen ? Styles.p__open : Styles.p__closed
          }>Quick Recipes</p>
              </Link>
              <Link className={`${Styles.link} ${Styles.separator}`} href="/myRecipes">
                <img src="myrec.png" alt="my recipes" width="30px" height="30px" /> <p className={
            isMenuOpen ? Styles.p__open : Styles.p__closed
          }>My Recipes</p>
              </Link>
              <Link className={`${Styles.link} ${Styles.separator}`} href="/addRecipes">
                <img src="home.png" alt="add recipe" width="30px" height="30px" /> <p className={
            isMenuOpen ? Styles.p__open : Styles.p__closed
          }>Add Recipes</p>
              </Link>
            </div>
